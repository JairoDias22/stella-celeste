...
export default function Sidebar({
  ...
  return (
    <>
      {/* Fundo escurecido, só aparece no mobile quando o menu está aberto */}
      {open && (
        <div
          onClick={onClose}
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-40 flex w-64 flex-col border-r border-white/10 bg-black/70 p-6 backdrop-blur-xl transition-transform duration-300 lg:static lg:z-0 lg:translate-x-0 lg:bg-black/40 ${
      ...
      >
        <div className="mb-10 flex items-center justify-between">
          ...
          <button
            onClick={onClose}
            className="flex h-8 w-8 items-center justify-center rounded-full border border-white/10 text-zinc-400 lg:hidden"
