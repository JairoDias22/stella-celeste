        ...
        <Container>
          ...
          <div className="grid gap-8 lg:grid-cols-3">
            ...
            >
              ...
              {msg && (
                <p className="mb-4 rounded-lg bg-violet-500/10 p-3 text-sm text-violet-300">{msg}</p>
              )}
              {error && (
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl lg:col-span-2">
              <div className="mb-6 flex items-center justify-between">
                ...
                <Link href="/agendar" className="inline-flex items-center gap-1.5 rounded-full bg-violet-600 px-4 py-2 text-sm font-medium text-white hover:bg-violet-700">
