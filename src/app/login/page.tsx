    ...
    <div className="flex min-h-screen items-center justify-center px-6 py-24">
      ...
      <div className="w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <h1 className="font-title text-3xl font-bold text-white">Bem-vinda de volta</h1>
          ...
          >
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <Link href="/esqueci-senha" className="text-xs text-zinc-500 hover:text-pink-300">
                  Esqueci minha senha
                </Link>
              </div>
              <PasswordInput
        ...
        <p className="mt-6 text-center text-sm text-zinc-500">
          Não tem conta?{" "}
          <Link href="/cadastro" className="font-medium text-pink-300 hover:text-pink-200">
            Criar conta
          </Link>
        </p>
